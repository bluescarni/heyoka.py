...
conda create -y -q -p $deps_dir python=3.8 git pybind11 numpy mpmath cmake llvmdev boost-cpp mppp sleef fmt"<8" spdlog sphinx myst-nb matplotlib pip sympy scipy pykep
