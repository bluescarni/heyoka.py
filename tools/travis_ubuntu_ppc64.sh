...
# GCC build.
cmake ../ -DCMAKE_INSTALL_PREFIX=$deps_dir -DCMAKE_PREFIX_PATH=$deps_dir -DCMAKE_BUILD_TYPE=Release -DHEYOKA_WITH_SLEEF=yes -DHEYOKA_WITH_MPPP=yes -DBoost_NO_BOOST_CMAKE=ON -DHEYOKA_INSTALL_LIBDIR=lib -DHEYOKA_FORCE_STATIC_LLVM=yes -DHEYOKA_HIDE_LLVM_SYMBOLS=yes
