...
conda create -y -q -p $deps_dir cxx-compiler c-compiler cmake llvmdev boost-cpp xtensor xtensor-blas blas blas-devel fmt"<8" spdlog python=3.8 pybind11 numpy mpmath sympy cloudpickle
