...
conda create -y -q -p $deps_dir python=3.10 git pybind11 'numpy>=2' mpmath cmake llvmdev tbb-devel tbb libboost-devel 'mppp=2.*' sleef fmt skyfield spdlog sympy cloudpickle c-compiler cxx-compiler
