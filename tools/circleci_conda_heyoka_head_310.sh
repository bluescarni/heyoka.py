...
conda create -y -q -p $deps_dir python=3.10 git pybind11 numpy mpmath cmake llvmdev tbb-devel tbb astroquery boost-cpp mppp sleef 'fmt=8.1.*' 'spdlog=1.10.*' sphinx myst-nb matplotlib sympy scipy pykep cloudpickle sphinx-book-theme
