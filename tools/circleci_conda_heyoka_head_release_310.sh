...
mamba create -y -q -p $deps_dir python=3.10 git pybind11 numpy mpmath cmake llvmdev tbb-devel tbb astroquery boost-cpp mppp sleef fmt spdlog myst-nb matplotlib sympy scipy pykep cloudpickle 'sphinx=6.*' 'sphinx-book-theme=1.*'
